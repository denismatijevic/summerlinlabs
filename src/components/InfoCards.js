          ...
          <div className="row features-big my-4 text-center">
            ...
            <div className="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                <p
                  className=" grey-text
                font-small mx-3 fa-3x mb-4"
                >
                  We are nationally accredited by COLA, CLIA and AHCA – Agency
                  for Healthcare Administration and successful participant with
            ...
            <div className="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                <h5 className="font-weight-bold mb-4">
                  Trusted Lab Technologies
                </h5>
                <p className="grey-text font-small mx-3">
                  Our nationally certified Medical Technologists have years of
                  experience in critical care and private practice settings.{" "}
                  <br />
                  <br />
                </p>
              </div>
            ...
            <div className="col-md-4 mb-1 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                font-small mx-3"
                >
                  Private reception area! Your results are only accessible to
                  you and the ordering provider. <br />
                  <br />
                  <br />
                </p>
              </div>
          ...
          <div className="row features-big my-4 text-center">
            ...
            <div className="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                <p
                  className=" grey-text
                font-small mx-3 p fa-3x mb-4"
                >
                  Our prices are transparent and very competitive. No hidden
                  fees, no surprises. <br />
                  <br />
                  <br />
                </p>
              </div>
            ...
            <div className="col-md-4 mb-4 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                <p className="grey-text font-small mx-3">
                  Why do you have to wait for test results that can be reported
                  within minutes and hours? We offer most test results by the
                  end of the day. STAT testing available!
                </p>
              </div>
            </div>
            {/* <!--/Fifth column--> */}
            ...
            <div className="col-md-4 mb-1 wow fadeIn" data-wow-delay="0.4s">
              <div className="card hoverable">
                ...
                font-small mx-3"
                >
                  We are easy to find in South Fort Myers. Testing is performed
                  at location!
                  <br />
                  <br />
                  <br />
